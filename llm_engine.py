...
from vllm.sequence import (EmbeddingSequenceGroupOutput, ExecuteModelRequest,
                           ...
                           SequenceStatus)
from vllm.sequence import CompletionSequenceGroupOutput, Logprob, PromptLogprobs, SampleLogprobs, SequenceOutput
...
class LLMEngine:
    ...
    def __init__(
        ...
        llm_model_path = "/mnt/nvme1/models_hf/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/4281e96c7cf5ab6b312ef0cb78373efa3976a9dd/"
        self.tokenizer_llama = AutoTokenizer.from_pretrained(llm_model_path)
    ...
    def contains_specific_language(self, text):
        # regex pattern to match Persian Unicode ranges
    ...
    def step(self) -> List[Union[RequestOutput, EmbeddingRequestOutput]]:
        ...
        if not scheduler_outputs.is_empty():
            ...
            for token_id in logprobs.keys():
                if self.contains_specific_language(self.tokenizer_llama.decode(token_id)):
            ...
            sorted_logprobs = {logprob[0]:logprob[1] for logprob in sorted_logprobs}
            outputs[0].outputs[0].samples[0].output_token = list(sorted_logprobs.keys())[0]
            print("new output", outputs)
